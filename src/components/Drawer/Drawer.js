...
const arrMenu = [
    ...
    { 'id': 1, name: 'Favourite', 'icon': 'heart-multiple-outline', 'navScreen': 'FavouriteScreen' },
    { 'id': 2, name: 'Messages', 'icon': 'comment-text-multiple', 'navScreen': 'MessagesScreen' },
            ...
            <SafeAreaView style={styles.container}>
                ...
                <View style={styles.headerContainer}>
                    <View style={{ flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'center' }}>
                        ...
                        <Text style={{ color: '#fff', fontSize: 22, fontWeight: '600', paddingLeft: 10 }}>Halli</Text>
                    </View>
                </View>
                <View style={styles.menuContainer}>
                    {this.renderFlatList()}
                </View>
                <View style={[styles.footerContainer, { bottom: (screenHeight > 800) ? 10 : 5 }]}>
